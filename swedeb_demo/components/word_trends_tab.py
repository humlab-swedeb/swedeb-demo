...
class WordTrendsDisplay(ToolTab):
    def __init__(self, another_api: ADummyApi, shared_meta: MetaDataDisplay) -> None:
        super().__init__(another_api, shared_meta, "wt_form")
        st.caption("Sök på ett begrepp för att hur det använts över tid. Välj vilka talare ska ingå till vänster.")
    ...
    def show_display(self) -> None:
        ...
        kwic_like_data = self.get_kwic_like_data(
            self.api, hits, slider[0], slider[1], selections
        )
